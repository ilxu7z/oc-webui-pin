...
function mkEl(){
  ...
  // v10: 移除 badge span — input 已显示完整路径，badge 是重复的
  var bd=null;
  ub();
  ...
  _lockEl=w; _lockInp=inp; _lockBd=null; // _lockIcon 已在上方赋值
  ...
  w.appendChild(lb);
  w.appendChild(inp);
  // v10: 不再 appendChild(bd) — badge 已移除
  return w;
}
